...
function validateTelegramInitData(initData) {
    ...
    if (!hash)
        return null;
    params.delete('hash');
    var sorted = __spreadArray([], params.entries(), true).sort(function (_a, _b) {
        var a = _a[0];
        var b = _b[0];
        ...
        .join('\n');
    var secretKey = crypto_1.default
    ...
    if (expected !== hash)
        return null;
    var result = {};
    params.forEach(function (v, k) { result[k] = v; });
    return result;
}
...
function getOrCreateUser(telegramUser) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, prisma_1.prisma.user.upsert({
